...
const createBookHandler = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    // Validating genreId is a valid ObjectId and exists in the database
    ...
    // Validating categoryId is a valid ObjectId and exists in the database
    ...
    // Preparing book data for saving
    const bookData = {
